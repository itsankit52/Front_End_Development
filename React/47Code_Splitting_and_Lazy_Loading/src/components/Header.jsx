    ...
    return (
        <header className="flex justify-between px-4 py-4 shadow-md md:px-8">
            ...
            <ul className="flex gap-4">
                ...
                <li>
                    <button className='cursor-pointer rounded-md bg-gray-300 px-6 py-2 font-semibold hover:bg-gray-400/80 active:bg-gray-400/60' onClick={() => setIsOpen(true)}>Click Here</button>
                    <Modal
